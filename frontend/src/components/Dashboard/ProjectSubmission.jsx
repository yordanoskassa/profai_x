...
const ProjectSubmission = () => {
  ...
  useEffect(() => {
    ...
    console.log("videoGenerated:", videoGenerated);

    if (isApproved) {
      // Fetch data when approval is true
      fetchAvatars();
      fetchVoices();
    }
  }, [isApproved]);
        ...
        <div className="approved-message">
          ...
          {loading ? (
            ...
            <div>
              ...
              {/* Conditionally render the Fetch Avatar Video button */}
              {videoGenerated && (
                <button onClick={() => {}} className="fetch-avatar-video-button">Fetch Avatar Video</button>
              )}
            </div>
          )}
